      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12 lg:p-24 bg-[#0F0F0F] relative">
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            {/* Market Selection */}
            <div role="group" aria-label="Select market" className="flex justify-center gap-4 py-2">
              {[
                { code: "US", label: "US" },
                { code: "MX", label: "MX" },
                { code: "CH", label: "CH" },
                ...
                <button
                  key={m.code}
                  type="button"
                  aria-pressed={selectedMarket === m.code}
            ...
            {error && (
              <div role="alert" aria-live="assertive" data-testid="login-error" className="bg-red-500/10 border border-red-500/20 text-red-500 px-4 py-3 rounded-xl text-sm font-medium text-center">
                {error}
              </div>
            )}
