...
export const TOPPING_GROUPS = [
  {
    ...
    items: [
      { id: "pepperoni", label: { en: "Pepperoni", es: "Pepperoni", de: "Pepperoni", fr: "Pepperoni", ja: "ペパロニ" } },
      { id: "york_ham", label: { en: "York ham", es: "Jamón york", de: "Kochschinken", fr: "Jambon", ja: "ハム" } },
      { id: "italian_sausage", label: { en: "Italian sausage", es: "Salchicha italiana", de: "Italienische Wurst", fr: "Saucisse italienne", ja: "イタリアンソーセージ" } },
  ...
  },
  {
    ...
    items: [
      { id: "mozzarella", label: { en: "Mozzarella", es: "Mozzarella", de: "Mozzarella", fr: "Mozzarella", ja: "モッツァレラ" } },
  ...
  },
  {
    ...
    items: [
      { id: "mushrooms", label: { en: "Mushrooms", es: "Champiñones", de: "Pilze", fr: "Champignons", ja: "きのこ" } },
      { id: "red_peppers", label: { en: "Red peppers", es: "Pimientos rojos", de: "Rote Paprika", fr: "Poivrons rouges", ja: "赤ピーマン" } },
      { id: "cherry_tomatoes", label: { en: "Cherry tomatoes", es: "Tomates cherry", de: "Cherrytomaten", fr: "Tomates cerises", ja: "ミニトマト" } },
      { id: "black_olives", label: { en: "Black olives", es: "Aceitunas negras", de: "Schwarze Oliven", fr: "Olives noires", ja: "ブラックオリーブ" } },
...
export const UI_STRINGS = {
  title: { en: "Customize your pizza", es: "Configura tu pizza", de: "Pizza konfigurieren", fr: "Personnaliser", ja: "ピザをカスタム" },
  size: { en: "Size", es: "Tamaño", de: "Größe", fr: "Taille", ja: "サイズ" },
  toppings: { en: "Toppings", es: "Toppings", de: "Beläge", fr: "Garnitures", ja: "トッピング" },
  upTo10: { en: "Up to 10 toppings", es: "Hasta 10 toppings", de: "Bis zu 10 Beläge", fr: "Jusqu’à 10", ja: "最大10個" },
